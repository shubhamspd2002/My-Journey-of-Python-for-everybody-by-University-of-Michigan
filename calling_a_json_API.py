...
#Test Data / Sample Execution: You can test to see if your program is working with a location of "University of Colorado at Boulder" 
# which will have a place_id of "ChIJwR6cajTsa4cR2TH0qKTVKAM".
'''
$ python3 solution.py
...
'''
#Turn In: Please run your program to find the place_id for this location:
#Make sure to enter the name and case exactly as above and enter the place_id and your Python code below. 
# Hint: The first seven characters of the place_id are "ChIJ_3L ..."
